...
def pretend_to_be_vtunetTrainer(folder, checkpoints=("model_best.model.pkl", "model_final_checkpoint.model.pkl")):
    pretend_to_be_other_trainer(folder, "vtunetTrainer", checkpoints)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Use this script to change the vtunet trainer class of a saved '
                                                 ...
                                                 'experimental and only to be used by advanced himashis.')
