...
from vtunet.inference.segmentation_export import save_segmentation_nifti_from_softmax, save_segmentation_nifti
...
from vtunet.postprocessing.connected_components import load_remove_save, load_postprocessing
from vtunet.training.model_restore import load_model_and_checkpoint_files
from vtunet.training.network_training.vtunetTrainer import vtunetTrainer

from vtunet.utilities.one_hot_encoding import to_one_hot
...
def preprocess_multithreaded(trainer, list_of_lists, output_files, num_processes=2, segs_from_prev_stage=None):
    ...
    assert isinstance(trainer, vtunetTrainer)
    q = Queue(1)
    processes = []
