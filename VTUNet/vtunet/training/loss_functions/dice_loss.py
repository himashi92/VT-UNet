...
import torch
from vtunet.training.loss_functions.TopK_loss import TopKLoss
from vtunet.training.loss_functions.crossentropy import RobustCrossEntropyLoss
...
class DC_and_CE_loss(nn.Module):
    ...
    def forward(self, net_output, target):
        print(f"Inside DCE loss {self.weight_ce} {self.weight_dice}")
        """
