...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        if 'vtunet_use_progress_bar' in os.environ.keys():
            self.use_progress_bar = bool(int(os.environ['vtunet_use_progress_bar']))
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        ...
        # print("save pth")
        torch.save(save_this, "model_best.pth")
    ...
    def plot_network_architecture(self):
        """
        can be implemented (see vtunetTrainer) but does not have to. Not implemented here because it imposes stronger
