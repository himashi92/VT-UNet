...
from vtunet.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from vtunet.experiment_planning.utils import create_lists_from_splitted_dataset
from vtunet.network_architecture.generic_UNet import Generic_UNet
from vtunet.paths import *
from vtunet.preprocessing.cropping import get_case_identifier_from_npz
...
class ExperimentPlanner(object):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "vtunetPlans" + "fixed_plans_3D.pkl")
    ...
    def plan_experiment(self):
        ...
        # thanks Zakiyi (https://github.com/MIC-DKFZ/vtunet/issues/61) for spotting this bug :-)
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join(vtunet.__path__[0], "preprocessing")],
                                                         self.preprocessor_name, current_module="vtunet.preprocessing")
...
if __name__ == "__main__":
    ...
    for i in task_ids:
        i = int(i)
        candidates = subdirs(vtunet_cropped_data, prefix="Task%03.0d" % i, join=False)
