...
from vtunet.experiment_planning.utils import split_4d
from vtunet.utilities.file_endings import remove_trailing_slash
...
def main():
    ...
    parser = argparse.ArgumentParser(description="The MSD provides data as 4D Niftis with the modality being the first"
                                                 " dimension. We think this may be cumbersome for some himashis and "
