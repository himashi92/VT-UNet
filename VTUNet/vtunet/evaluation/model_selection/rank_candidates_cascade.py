...
if __name__ == "__main__":
    ...
    plans = "vtunetPlansv2.1"

    overwrite_plans = {
        'vtunetTrainerCascadeFullRes': ['vtunetPlans'],
    }

    trainers = [
        'vtunetTrainerCascadeFullRes',
        'vtunetTrainerV2CascadeFullRes_EducatedGuess',
        'vtunetTrainerV2CascadeFullRes_EducatedGuess2',
        'vtunetTrainerV2CascadeFullRes_EducatedGuess3',
        'vtunetTrainerV2CascadeFullRes_lowerLR',
        'vtunetTrainerV2CascadeFullRes',
        'vtunetTrainerV2CascadeFullRes_noConnComp',
        'vtunetTrainerV2CascadeFullRes_shorter_lowerLR',
        'vtunetTrainerV2CascadeFullRes_shorter',
        'vtunetTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
