...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'vtunetTrainerV2_2': ["vtunetPlans", "vtunetPlans_customClip"], # r
        'vtunetTrainerV2_2_noMirror': ["vtunetPlans", "vtunetPlans_customClip"],  # r
        'vtunetTrainerV2_lessMomentum_noMirror': ["vtunetPlans", "vtunetPlans_customClip"],  # r
        'vtunetTrainerV2_2_structSeg_noMirror': ["vtunetPlans", "vtunetPlans_customClip"],  # r
        'vtunetTrainerV2_2_structSeg': ["vtunetPlans", "vtunetPlans_customClip"],  # r
        'vtunetTrainerV2_lessMomentum_noMirror_structSeg': ["vtunetPlans", "vtunetPlans_customClip"],  # r
        'vtunetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["vtunetPlans", "vtunetPlans_customClip"],  # r
        'vtunetTrainerV2_FabiansResUNet_structSet_NoMirror': ["vtunetPlans", "vtunetPlans_customClip"],  # r
        'vtunetTrainerV2_FabiansResUNet_structSet': ["vtunetPlans", "vtunetPlans_customClip"],  # r

    }

    trainers = ['vtunetTrainer'] + [
        'vtunetTrainerV2_2',
        'vtunetTrainerV2_lessMomentum_noMirror',
        'vtunetTrainerV2_2_noMirror',
        'vtunetTrainerV2_2_structSeg_noMirror',
        'vtunetTrainerV2_2_structSeg',
        'vtunetTrainerV2_lessMomentum_noMirror_structSeg',
        'vtunetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'vtunetTrainerV2_FabiansResUNet_structSet_NoMirror',
        'vtunetTrainerV2_FabiansResUNet_structSet',
    ]
