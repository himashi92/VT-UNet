...
from vtunet.evaluation.metrics import ConfusionMatrix, ALL_METRICS
...
class Evaluator:
    ...
    def evaluate(self, test=None, reference=None, advanced=False, **metric_kwargs):
        ...
        # somewhat convoluted, but allows himashis to define additonal metrics
